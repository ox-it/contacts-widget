(function ($) {
    ...
    contact_search =
    {
        ...
        create_form: function (params) {
            ...
            var $phoneButton = $("<input type='submit' name='find_phone' alt='Find telephone numbers' value='Phone'>");
            ...
            var $emergency_link = $('<a href="//estates.admin.ox.ac.uk/emergency-contacts/" name="emergency_numbers" title="Emergency numbers" id="emergency_numbers">');
